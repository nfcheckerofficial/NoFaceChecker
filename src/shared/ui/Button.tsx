    ...
    return (
      <button
        ...
        className={clsx(
          ...
          'border-2 border-current inline-flex items-center justify-center gap-2',
          ...
          'group/button',
          {
            ...
            'bg-red-950/40 text-red-400 border-red-400 hover:bg-red-900/50 hover:shadow-[0_0_20px_rgba(239,68,68,0.5)]': variant === 'danger',
      ...
      >
        {loading && (
          <Loader2 size={size === 'lg' ? 20 : size === 'sm' ? 12 : 16} className="animate-spin" />
        )}
        <span className={clsx('relative z-10 transition-colors', !loading && 'group-hover/button:text-white')}>{children}</span>
